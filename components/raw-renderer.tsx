  ...
  return (
    <>
      <button
        ...
        onClick={openModal}
        //@ts-ignore
        className={`z-10 relative flex items-center px-5 py-2 mx-3 my-2 font-semibold text-sm transition duration-150 ease-out rounded-full transform focus:shadow-outline focus:outline-hidden whitespace-nowrap opacity-80 hover:opacity-100 shadow-md ${buttonColorClasses[theme!.color!]
          }`}
      >
        View Raw Data
        <span
